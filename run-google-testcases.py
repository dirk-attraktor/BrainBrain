...
def train(taskname):
    ...
    problem_regression = Regression("google_testcases-%s" % taskname, max_generations = -1, max_individuals = 200000,max_populationsize = 100, max_code_length=150,min_code_length=30,max_steps = 5000,usePriorKnowledge=False)
